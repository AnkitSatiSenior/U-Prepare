                    ...
                    <table class="table table-bordered align-middle text-center">
                        ...
                        <tbody>
                            ...
                            @foreach ($boqEntries as $parentSlNo => $entries)
                                @php
                                    $parentEntry = $entries->first(); // first entry in the group
                                @endphp
                                <tr class="table-primary fw-bold">
                                    ...
                                    <td class="text-end">
                                        {{ $physicalProgress[$parentEntry->id]->up_to_date->qty ?? 0 }}
                                    </td>
                                    <td class="text-end">
                                        {{ formatPrice($physicalProgress[$parentEntry->id]->up_to_date->amount ?? 0) }}
                                    </td>
                                </tr>
                                ...
                                @foreach ($entries as $entry)
                                    ...
                                    @if ($entry->sl_no != $parentSlNo)
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                {{ $physicalProgress[$entry->id]->up_to_date->qty ?? 0 }}
                                            </td>
                                            <td class="text-end">
                                                {{ formatPrice($physicalProgress[$entry->id]->up_to_date->amount ?? 0) }}
                                            </td>
                                        </tr>
                                    @endif
                                @endforeach
