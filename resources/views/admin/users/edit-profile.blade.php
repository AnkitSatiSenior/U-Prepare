                    ...
                    <div class="card-body p-sm-5">
                        ...
                        <form action="{{ route('admin.users.profile.update', $user->id) }}" method="POST">
                            ...
                            <div class="row g-4 mb-5">
                                <div class="col-md-4">
                                    <label for="dob" class="form-label text-muted fw-medium small mb-1">Date of Birth</label>
                                ...
                                <div class="col-md-4">
                                    <label for="date_of_joining" class="form-label text-muted fw-medium small mb-1">Date of Joining</label>
                                ...
                                <div class="col-md-4">
                                    <label for="total_work_experience" class="form-label text-muted fw-medium small mb-1">Total Work Experience</label>
                                    <input type="text" id="total_work_experience" name="total_work_experience" 
                            ...
                            <div class="row g-4 mb-4">
                                <div class="col-12">
                                    <label for="qualification" class="form-label text-muted fw-medium small mb-1">Qualification(s)</label>
                                ...
                                <div class="col-12">
                                    <label for="area_of_expertise" class="form-label text-muted fw-medium small mb-1">Area of Expertise</label>
                                    <textarea id="area_of_expertise" name="area_of_expertise" rows="3" 
                                ...
                                <div class="col-12">
                                    <label for="research_publication_citation" class="form-label text-muted fw-medium small mb-1">Research / Publications / Citations</label>
                                    <input type="text" id="research_publication_citation" name="research_publication_citation" 
                                ...
                                <div class="col-12">
                                    <label for="previous_experience" class="form-label text-muted fw-medium small mb-1">Previous Experience (Last 3 Organizations)</label>
