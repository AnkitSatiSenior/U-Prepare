<x-app-layout>
    <div class="container-fluid py-4">
        <x-admin.breadcrumb-header icon="fas fa-layer-group text-primary" title="All Sub-Projects Report" :breadcrumbs="[
        ...
        <div class="card shadow-sm mb-4">
                ...
                <form id="filterForm" method="GET" class="row g-3 align-items-end">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="sub_department_id" id="sub_department_id" class="form-select">
                            ...
                            <option value="{{ $subDept->id }}" {{ request('sub_department_id')==$subDept->id ?
                                'selected' : '' }}>
                                {{ $subDept->name }}
                            </option>
                            @endforeach
            ...
            <div class="card-body">
                <x-admin.data-table id="all-sub-projects-table" :headers="array_merge(
                ...
                )" :excel="true" :print="true" :pageLength="10" :resourceName="'sub-projects'">
                    ...
                    <tr>
                        ...
                        <td class="{{ $sp['physicalPercent'] > 0 ? 'bg-light-success-lte align-middle' : 'bg-light-danger-lte align-middle' }} 
                            ...
                            <a
                                href="{{ url('/admin/physical_boq_progress_get') }}?sub_package_project_id={{ $sp['id'] }}">
                                {{ $sp['physicalPercent'] }}%
                            </a>
                        ...
                        <td class="{{ $sp['financePercent'] > 0 ? 'bg-light-success-lte align-middle' : 'bg-light-danger-lte align-middle' }} 
